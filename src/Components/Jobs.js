    ...
    return (
        <div class='Jobs'>
            ...
            <center>
                ...
                <button class="join" onClick={() => window.open('https://discord.gg/7cSTtpgK')}>Join Us</button>
                ...
                <h1 class="why-body">
                    ...
                    <br/><br/><br/>
                    You can apply for a job on our <a href="https://discord.gg/7cSTtpgK">discord server</a> at <h1 class="why-ds">#📌-info</h1> section
